    ...
    try{
        ...
        if(!checkUser){
            ...
            if(!valid){
                ...
                // CREATING TOKEN FOR VALIDATION OF USER TO PERFORM OPERATIONS
                const token = jwt.sign(
                    { exp: Math.floor(Date.now()/1000)*(60*60*60),
                        id: checkUser.id
                    }, "SecretKey", )

                const userdetails = {...checkUser._doc, password: undefined} // WE DON'T WANT TO SEND BACK THE PASSWORD 
